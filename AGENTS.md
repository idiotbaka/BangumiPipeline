...
- `frontend/apps/admin/src/pages/AppReleaseManagementPage.vue`：移动端 APP 版本列表、arm64-v8a APK 与更新日志发布。
...
- APP 最新版本信息和 APK 下载接口为公开接口；H5 下载页路径固定为 `/app/download`，不进入观看端登录门禁。
